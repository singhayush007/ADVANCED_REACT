# Event Handling - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Event Handling` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **Event Handling:** React me user actions (`onClick`, `onChange`, `onSubmit`) se logic run hota hai.
- **Synthetic Event:** React browser events ko normalize karke synthetic event object deta hai.
- **Handler Function:** Event handler function me business logic likh kar state update karte hain.

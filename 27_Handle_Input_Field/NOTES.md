# Handle Input Field - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Handle Input Field` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **Controlled Component:** Input value state se control hoti hai; source of truth React state hoti hai.
- **onChange:** Input change event se state update hoti hai.
- **Form Data Flow:** User input -> state -> UI/submit logic flow follow hota hai.

# State - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `State` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **State:** State component ka internal dynamic data hota hai.
- **Immutable Update:** State update karte waqt direct mutate nahi karna, naya value/object banana hota hai.
- **UI Sync:** State aur UI sync me hone chahiye taki output predictable rahe.

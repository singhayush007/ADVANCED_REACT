# React Icons - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `React Icons` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **React Icons:** `react-icons` package multiple icon libraries ko React components ke form me deta hai.
- **Icon Component:** Icon ko component ki tarah render karke size/color props se customize karte hain.

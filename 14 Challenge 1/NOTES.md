# Challenge 1 - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Challenge 1` topic ko step-by-step practical code ke through implement kiya gaya hai.
- Main goal: concept samajhna + uska practical implementation dekhna.

## Important Files (Yahi Dekho Pehle)
- (Core files minimal hain; concept demo-focused folder hai.)

## Concept Kya Hai? (Simple Hinglish Explanation)
- **Problem Solving:** Challenge folders me concept apply karke practical solution banana hota hai.
- **Concept Integration:** Ek hi task me state, props, events, rendering multiple concepts combine hote hain.

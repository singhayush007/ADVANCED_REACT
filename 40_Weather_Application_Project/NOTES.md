# Weather Application Project - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Weather Application Project` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- `src/components/ForecastDetails.jsx`
- `src/components/Search.jsx`
- `src/main.jsx`
- `src/store/actions/weatherAction.js`

## Concept Kya Hai? (Simple Hinglish Explanation)
- **API Query:** City/search ke basis par weather API request bheji jati hai.
- **Data Rendering:** Response data ko parse karke temperature, condition, etc UI me show hota hai.

# Radio Buttons - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Radio Buttons` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **Radio Buttons:** Radio group me ek time par sirf ek option select hota hai.
- **Single Selection State:** Selected value ko ek state variable me store karte hain.

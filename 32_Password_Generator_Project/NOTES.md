# Password Generator Project - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Password Generator Project` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **Derived Data:** Password options ke basis par generated output milta hai.
- **State-driven Controls:** Length/symbol/number toggles state se controlled rehte hain.

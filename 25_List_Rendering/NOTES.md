# List Rendering - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `List Rendering` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **List Rendering:** Array data ko `map()` se UI elements me convert karte hain.
- **Key Prop:** Har list item me unique `key` dena React diffing ke liye important hai.
- **Dynamic UI:** Data badalte hi list automatically update hoti hai.

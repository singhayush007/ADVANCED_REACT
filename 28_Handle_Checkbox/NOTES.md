# Handle Checkbox - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Handle Checkbox` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **Checkbox Input:** Checkbox boolean ya multi-select choice represent karta hai.
- **Checked State:** `checked` prop aur `onChange` se checkbox ko controlled banate hain.

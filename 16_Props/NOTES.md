# Props - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Props` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- `src/components/DefaultProps.jsx`
- `src/components/Layout.jsx`
- `src/main.jsx`

## Concept Kya Hai? (Simple Hinglish Explanation)
- **Props:** Props parent se child component ko data pass karne ka tarika hai.
- **One-way Data Flow:** React me data normally parent se child direction me jata hai.
- **Read-only:** Child component props ko direct modify nahi karta; wo sirf consume karta hai.

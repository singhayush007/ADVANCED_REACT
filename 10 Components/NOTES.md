# Components - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Components` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **Reusable Components:** Ek baar component banao, multiple jagah use karo with different props.
- **Component Tree:** React app components ka hierarchy/tree hota hai jahan parent-child relation hota hai.
- **Separation of Concerns:** UI ko logical parts me todne se code maintain karna easy hota hai.

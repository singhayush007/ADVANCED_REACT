# Ecom Project - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Ecom Project` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **App Architecture:** Multiple screens/components ko modular structure me organize kiya jata hai.
- **State Management:** Cart/product/filter jaisi states ko structured way me handle karte hain.

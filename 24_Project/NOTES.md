# Project - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Project` topic ko step-by-step practical code ke through implement kiya gaya hai.
- Main goal: concept samajhna + uska practical implementation dekhna.

## Important Files (Yahi Dekho Pehle)
- `MiniProject_1/eslint.config.js`
- `MiniProject_1/src/App.jsx`
- `MiniProject_1/src/Popup.jsx`
- `MiniProject_1/src/main.jsx`
- `MiniProject_1/vite.config.js`
- `MiniProject_2/Navbar.jsx`

## Concept Kya Hai? (Simple Hinglish Explanation)
- **Core React Concept:** Is folder me **Project** concept ko practical code se samjhaya gaya hai.
- **Hands-on Flow:** User input/events aur state updates ke through final UI behavior build hota hai.

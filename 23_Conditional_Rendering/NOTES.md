# Conditional Rendering - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Conditional Rendering` topic ko step-by-step practical code ke through implement kiya gaya hai.
- Main goal: concept samajhna + uska practical implementation dekhna.

## Important Files (Yahi Dekho Pehle)
- `src/App.jsx`
- `src/component/ComponentA.jsx`
- `src/component/ComponentB.jsx`
- `src/component/ComponentC.jsx`
- `src/main.jsx`

## Concept Kya Hai? (Simple Hinglish Explanation)
- **Conditional Rendering:** Condition true/false ke basis par different UI render karte hain.
- **Ternary Operator:** `condition ? A : B` pattern se concise UI branching hoti hai.
- **Short-circuit:** `condition && <Component />` se conditional block quickly show karte hain.

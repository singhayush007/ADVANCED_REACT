# Styles - Detailed Hinglish Notes

## Is Folder me Kya Hua Hai?
- Is folder me `Styles` topic ko step-by-step practical code ke through implement kiya gaya hai.
...
- **CSS in React:** React me styling normal CSS, module CSS, inline styles ya libraries se hoti hai.
- **className:** React me HTML `class` ki jagah `className` use hota hai.
- **Inline Style:** Inline style object format me likhte hain, jaise `style={{ color: "red" }}`.
